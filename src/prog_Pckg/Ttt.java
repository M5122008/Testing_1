...
public class Ttt {
  ...
  public void testTtt() throws Exception {
    ...
    driver.findElement(By.name("search_query")).sendKeys("kung fu panda");
    driver.findElement(By.id("search-icon-legacy")).click();
    driver.findElement(By.linkText("Kung Fu Panda (2008) Best Scenes | Po vs Tai Lung Fight Scenes")).click();
  }
